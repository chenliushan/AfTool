...
//        String[] encodings=new String[]{"UTF-8"};g
        ...
        String source = ReadFileUtils.readFile("/Users/liushanchen/IdeaProjects/AfTest" + "/src/main/java/polyu_af/MyList1.java");
...
//        }
    ...
    private static ASTNode findTheNodePL(ASTNode root) {
        ...
        */
        String source = ReadFileUtils.readFile(System.getProperty("user.dir") + "/input/AfToolInput");
...
//                logger.info("nodeFinder.getCoveringNode(): " + nodeScope);
    ...
    private static CompilationUnit createNode(char[] source, String[] classpathEntries, String[] sourcepathEntries, String[] encodings) {
        ...
        String s="";
        logger.info("classpathEntries: "+s.join(",",classpathEntries));
        logger.info("sourcepathEntries: "+s.join(",",sourcepathEntries));
        logger.info("encodings: "+s.join(",",encodings));
